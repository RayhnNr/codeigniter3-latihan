<form id="formproduct_type">
    <div class="modal-header">
        <h5 class="modal-title">Tambah Tipe Product</h5>
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            <label>Nama Tipe product</label>
            <input type="text" name="product_type_name" class="form-control" value="">
            <small class="text-danger" id="error_product_type_name"></small>
        </div>

        <div class="form-group">
            <label>Status</label>
            <input type="hidden" name="status" id="product_type_status_value" value="<?= (int) $active_status_id ?>">
            <input type="checkbox" 
