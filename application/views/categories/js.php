...
window.addEventListener('load', function () {
    ...
    table = $('#table-category').DataTable({
        ...
        responsive: true,
        ajax: {
            url: '<?= base_url('categories/get_data') ?>',
            type: 'POST',
            dataSrc: 'data'
        },
        columns: [
    ...
    function initCategoryStatusToggle() {
        var toggle = $('#categories_status');
    ...
    $('#btn_add').on('click', function () {
        $.ajax({
            url: '<?= base_url('categories/ajax_form') ?>',
            type: 'POST',
            success: function (response) {
                $('#modalFormContent').html(response);
                initCategoryStatusToggle();
    ...
    $(document).on('click', '.btn-edit', function () {
        ...
        $.ajax({
            url: '<?= base_url('categories/ajax_edit') ?>',
            type: 'POST',
            data: { id: id },
            success: function (response) {
                $('#modalFormContent').html(response);
    ...
    // submit form (dipakai bareng untuk TAMBAH & EDIT, karena keduanya id="formCategory")
