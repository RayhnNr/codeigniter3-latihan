...
class Product_type_model extends MY_Model{
    ...
    protected $_primary_key = 'product_type_id';
    ...
    public function get_all_with_status(){
        $this->db->select('product_type.*, product_status.product_status_name');
        $this->db->from($this->_table_name);
        $this->db->join('product_status', 'product_status.product_status_id = product_type.status', 'left');
